...
func TestCloseActiveForced(t *testing.T) {
	...
	code := Close(s, cfg, "T-003", "done", CloseOpts{AllowMissingCapture: "test: capture gate not under test", SkipAC: "test: AC gate not under test", SkipACRequested: true, Force: true})
	if code != 0 {
...
func TestCloseAlreadyClosed(t *testing.T) {
	s, cfg := setupTestEnv(t)
	code := Close(s, cfg, "T-004", "done", CloseOpts{AllowMissingCapture: "test: capture gate not under test", SkipAC: "test: AC gate not under test", SkipACRequested: true, })
	if code != 1 {
...
func TestCloseGateFailure(t *testing.T) {
	...
	code := Close(s, cfg, "T-001", "done", CloseOpts{AllowMissingCapture: "test: capture gate not under test", SkipAC: "test: AC gate not under test", SkipACRequested: true, })
...
func TestCloseNotFoundV3(t *testing.T) {
	s, cfg := setupTestEnv(t)
	code := Close(s, cfg, "T-999", "done", CloseOpts{AllowMissingCapture: "test: capture gate not under test", SkipAC: "test: AC gate not under test", SkipACRequested: true, })
	if code != 1 {
...
func TestCloseWithGateEnforcement(t *testing.T) {
	...
	code := Close(s, cfg, "T-001", "done", CloseOpts{AllowMissingCapture: "test: capture gate not under test", SkipAC: "test: AC gate not under test", SkipACRequested: true, Force: false})
	if code != 1 {
